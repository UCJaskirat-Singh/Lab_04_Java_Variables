...
public class Main {
    public static void main(String[] args) {
        ...
        int intQuotient = 14;
        int intModulo = 16;
        int doubleOperandA = (int) 7.50;
        int doubleOperandB = (int) 2.70;
        int doubleSum = (int) 5.50;
        int doubleProduct = (int) 3.80;
        int doubleDifference = (int) 9.90;
        int doubleQuotient = (int) 1.20;
        ...
        System.out.println("The Double Difference using ints of " + doubleOperandA + " " + doubleOperandB + " is " + doubleDifference);
        doubleQuotient = doubleOperandA / doubleOperandB;
        System.out.println("The Double Quotient using ints of " + doubleOperandA + " " + doubleOperandB + " is " + doubleQuotient);
    ...
    class Main2 {
        ...
        double packPokemonCost = 7.50;

        String favoriteColor = "red";

        double burgerMcdonaldPrice = 4.99;

        String fathersBirthMonth = "June";
